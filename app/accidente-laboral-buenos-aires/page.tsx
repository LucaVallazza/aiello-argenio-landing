    ...
    <div className="min-h-screen bg-white text-primary-800 font-['Timeless',serif]">
      ...
      <header className="relative bg-white border-b border-primary-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 md:px-6 md:py-5 flex justify-between items-center">
          <Link href="/" className="relative">
            <div className="text-xl md:text-2xl font-bold tracking-wider text-primary-800">
              AIELLO, ARGENIO & ASOC.
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 p-4 md:p-6 bg-primary-100 border border-primary-200 rounded-lg flex items-center shadow-sm">
            ...
            <p className="text-sm md:text-base text-primary-800">
              <span className="font-semibold text-primary-700">IMPORTANTE:</span> No firmes ningún documento sin asesoramiento legal. La consulta con nosotros es <span className="font-semibold text-primary-700">totalmente gratuita</span>
            </p>
          </div>
          ...
          <div className="prose prose-headings:text-primary-700 prose-a:text-primary-600 max-w-none mb-10 text-primary-800">
            ...
            <p className="text-primary-700 mb-6">
              En este artículo, te explicamos <span className="text-primary-600 font-semibold">paso a paso qué hacer si sufres un accidente laboral</span>, de manera simple y directa.
            </p>
          </div>
          ...
          <div className="space-y-10 mb-12">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-primary-700">1. Primeros pasos inmediatos</h2>
              <div className="bg-white border border-primary-200 rounded-lg p-5 md:p-6 shadow-sm">
                <ul className="space-y-4 text-primary-700">
                  <li className="flex">
                    ...
                    <span><span className="font-medium text-primary-800">Avisa a tu supervisor inmediatamente</span>. Por ley, debes informar el accidente lo antes posible.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span><span className="font-medium text-primary-800">Busca atención médica</span>. Tu salud es lo primero. Acude al servicio médico de la empresa o a una guardia.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span><span className="font-medium text-primary-800">Pide que documenten tus lesiones</span>. Es importante tener un registro médico oficial desde el primer momento.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span><span className="font-medium text-primary-800">Guarda toda la documentación</span> que te entreguen, sin excepción.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-primary-700">2. Denuncia el accidente</h2>
              <div className="bg-white border border-primary-200 rounded-lg p-5 md:p-6 shadow-sm">
                <ul className="space-y-4 text-primary-700">
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Tu empleador debe <span className="font-medium text-primary-800">denunciar el accidente a la ART</span> (Aseguradora de Riesgos del Trabajo) dentro de las 48 horas.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Si tu empleador no lo hace, <span className="font-medium text-primary-800">puedes hacer la denuncia tú mismo</span> llamando directamente a la ART.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Anota el <span className="font-medium text-primary-800">número de siniestro</span> que te asignen. Lo necesitarás para todos los trámites.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-primary-700">3. Durante tu recuperación</h2>
              <div className="bg-white border border-primary-200 rounded-lg p-5 md:p-6 shadow-sm">
                <ul className="space-y-4 text-primary-700">
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>La ART <span className="font-medium text-primary-800">debe cubrir todos tus gastos médicos</span> relacionados con el accidente.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>También debe <span className="font-medium text-primary-800">pagarte un salario mientras no puedas trabajar</span> (Incapacidad Laboral Temporaria).</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span><span className="font-medium text-primary-800">Cumple con los tratamientos</span>. Faltar a las citas médicas puede afectar tus beneficios.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span><span className="font-medium text-primary-800">Guarda copia de todos los certificados médicos</span> que te entreguen.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-primary-700">4. Problemas comunes y alertas</h2>
              <div className="bg-white border border-primary-200 rounded-lg p-5 md:p-6 shadow-sm">
                <div className="mb-4 p-3 bg-red-100 border border-red-300 rounded-md">
                  <p className="text-red-800 font-medium">¡ATENCIÓN! Situaciones que requieren asesoramiento legal inmediato:</p>
                </div>
                <ul className="space-y-4 text-primary-700">
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Si la ART <span className="font-medium text-primary-800">rechaza tu reclamo</span> o dice que no fue un accidente laboral.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Si te <span className="font-medium text-primary-800">presionan para volver al trabajo</span> antes de estar recuperado.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Si te <span className="font-medium text-primary-800">ofrecen firmar un acuerdo</span> o renuncia.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Si te <span className="font-medium text-primary-800">dan el alta médica</span> pero sigues con problemas de salud.</span>
                  </li>
                  <li className="flex">
                    <span className="text-primary-600 font-bold mr-2">•</span>
                    <span>Si la empresa <span className="font-medium text-primary-800">te despide después de un accidente</span>.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-primary-700">Tus derechos como trabajador accidentado</h2>
            
            <div className="bg-white border border-primary-200 rounded-lg p-5 md:p-6 space-y-5 shadow-sm">
              <p className="text-primary-800">La Ley de Riesgos del Trabajo (N° 24.557) establece que tienes derecho a:</p>
              
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-primary-50 p-4 rounded-md border border-primary-100">
                  <h3 className="font-semibold text-primary-700 mb-2">Atención médica completa</h3>
                  <p className="text-sm text-primary-600">Todos los gastos médicos, medicamentos y rehabilitación deben ser cubiertos por la ART.</p>
                </div>
                
                <div className="bg-primary-50 p-4 rounded-md border border-primary-100">
                  <h3 className="font-semibold text-primary-700 mb-2">Salario durante la recuperación</h3>
                  <p className="text-sm text-primary-600">Recibirás un pago mensual mientras estés de licencia por el accidente.</p>
                </div>
                
                <div className="bg-primary-50 p-4 rounded-md border border-primary-100">
                  <h3 className="font-semibold text-primary-700 mb-2">Indemnización por lesiones</h3>
                  <p className="text-sm text-primary-600">Si quedas con alguna incapacidad permanente, tienes derecho a una compensación.</p>
                </div>
                
                <div className="bg-primary-50 p-4 rounded-md border border-primary-100">
                  <h3 className="font-semibold text-primary-700 mb-2">Recalificación laboral</h3>
                  <p className="text-sm text-primary-600">Si no puedes volver a tu trabajo anterior, la ART debe ayudarte a capacitarte para otro puesto.</p>
                </div>
              </div>
          ...
          <div id="form-contacto" className="scroll-mt-10">
            ...
            <form className="relative p-6 md:p-8 bg-white rounded-md border border-primary-200 shadow-md">
              <div className="space-y-4 md:space-y-6 relative z-10">
                <div>
                  <label className="text-primary-600 text-xs md:text-sm mb-1 md:mb-2 block">Nombre completo</label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="text-primary-600 text-xs md:text-sm mb-1 md:mb-2 block">Teléfono</label>
                    <input
                      type="tel"
                      className="w-full bg-primary-50/50 border border-primary-200 p-3 md:p-4 rounded-md focus:outline-none focus:border-primary-400 transition-colors text-sm md:text-base text-primary-800"
                  ...
                  <div>
                    <label className="text-primary-600 text-xs md:text-sm mb-1 md:mb-2 block">Empresa donde ocurrió el accidente</label>
                    <input
                      type="text"
                      className="w-full bg-primary-50/50 border border-primary-200 p-3 md:p-4 rounded-md focus:outline-none focus:border-primary-400 transition-colors text-sm md:text-base text-primary-800"
                ...
                <div>
                  <label className="text-primary-600 text-xs md:text-sm mb-1 md:mb-2 block">¿Cuándo ocurrió el accidente?</label>
                  <input
                    type="date"
                    className="w-full bg-primary-50/50 border border-primary-200 p-3 md:p-4 rounded-md focus:outline-none focus:border-primary-400 transition-colors text-sm md:text-base text-primary-800"
                  />
                ...
                <div>
                  <label className="text-primary-600 text-xs md:text-sm mb-1 md:mb-2 block">Breve descripción del accidente</label>
                  <textarea
                    rows={3}
                ...
                <div className="flex items-start space-x-2">
                  <input type="checkbox" className="mt-1 bg-primary-50/50 border border-primary-300 rounded-sm" />
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
            <div className="p-4 rounded-md border border-primary-200 bg-white hover:border-primary-300 transition-colors duration-300 shadow-sm">
              ...
              <h3 className="text-sm font-medium text-primary-600 mb-1">Teléfono</h3>
              <a href={`tel:${contactPhoneNumeric}`} className="text-primary-800 hover:text-primary-900 transition-colors duration-300">{contactPhone}</a>
            </div>
            
            <div className="p-4 rounded-md border border-primary-200 bg-white hover:border-primary-300 transition-colors duration-300 shadow-sm">
              <Mail size={20} className="text-primary-600 mx-auto mb-2" />
              <h3 className="text-sm font-medium text-primary-600 mb-1">Email</h3>
              <a href={`mailto:${contactEmail}`} className="text-primary-800 hover:text-primary-900 transition-colors duration-300">{contactEmail}</a>
            </div>
            
            <div className="p-4 rounded-md border border-primary-200 bg-white hover:border-primary-300 transition-colors duration-300 shadow-sm">
              <MapPin size={20} className="text-primary-600 mx-auto mb-2" />
              <h3 className="text-sm font-medium text-primary-600 mb-1">Horario de atención</h3>
              <p className="text-primary-700">Lunes, Miércoles y Jueves de 16:00 a 19:00</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="bg-primary-800 py-6 md:py-8 px-4 md:px-6 border-t border-primary-700">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-primary-100 font-bold mb-4">AIELLO, ARGENIO & ASOC.</div>
          <div className="text-primary-300 text-xs">&copy; {new Date().getFullYear()} Lu&Co Soft. Sitio desarrollado para Aiello, Argenio & Asociados.</div>
        </div>
      </footer>
